...
if (!function_exists('get_md_rows')) :
...
if (!function_exists('get_md_edit')) :
...
if (!function_exists('get_md_view')) :
...
if (!function_exists('get_md_novo')) :
...
if (!function_exists('md_duplique')) :
...
if (!function_exists('converte_iso_to_utf8')) :
